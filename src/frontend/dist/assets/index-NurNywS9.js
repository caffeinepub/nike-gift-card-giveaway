      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-20 w-full max-w-5xl mx-auto px-6 py-20 flex flex-col items-center text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "button",
              className: `animate-cta-glow font-anton text-base md:text-lg tracking-widest uppercase px-12 py-4 text-white transition-all duration-200 hover:scale-105 active:scale-100 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`,
              style: {
                background: "oklch(0.52 0.22 25)",
